...
function downloadArtifact {
    ...
    # Download the artifact
        ...
        $errorMessage = "THERE IS NO 'LAST SUCCESSFUL ARTIFACT' FOR THE BRANCH '${selectedJobName}'."

        # Display warning on console
        Write-Warning $errorMessage

        # Call the ShowErrorMessage function from DialogueBox.ps1 to display the error message
